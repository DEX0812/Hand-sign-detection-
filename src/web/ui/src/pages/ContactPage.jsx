...
const InputField = ({ label, type = 'text', placeholder, value, onChange }) => (
  <div className="flex flex-col" style={{ gap: 'calc(var(--space-base) * 0.5)' }}>
    ...
    <input 
      ...
      className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all font-sans"
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen pt-48 pb-32 px-8 flex flex-col">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 items-center mb-48" style={{ gap: 'calc(var(--space-base) * 4)' }}>
        ...
        >
          ...
          <div className="flex flex-col" style={{ gap: 'calc(var(--space-base) * 1.5)' }}>
            <div className="flex items-center group" style={{ gap: 'var(--space-base)' }}>
          ...
          <AnimatePresence mode="wait">
            {!submitted ? (
              <motion.form 
                ...
                exit={{ opacity: 0, y: 20 }}
                className="glass-strong p-10 rounded-[2.5rem] border border-white/10 shadow-2xl flex flex-col antigravity-lift"
                style={{ gap: 'var(--space-base)' }}
              >
                <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 'var(--space-base)' }}>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all resize-none font-sans"
                    placeholder="Tell us about your project..."
                  />
                </div>

                <button 
                  className="w-full py-5 rounded-2xl bg-white text-black font-bold flex items-center justify-center transition-all active:scale-95 cursor-pointer antigravity-lift"
                  style={{ gap: 'calc(var(--space-base) * 0.5)' }}
                >
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, scale: 1 }}
                className="glass-strong p-12 rounded-[2.5rem] border border-emerald-500/20 shadow-2xl flex flex-col items-center justify-center text-center gap-6 h-full min-h-[460px] antigravity-lift"
              >
